...
public class ChemistryTopicsFragment extends Fragment {
    ...
    private View.OnClickListener onItemClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            String chemistryTopicName = FundoSpaceTopicsData.chemistryTopics[position];

            int itemId = Arrays.asList(FundoSpaceTopicsData.chemistryTopics).indexOf(chemistryTopicName);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        ChemistryTopicsListAdapter chemistryTopicsListAdapter = new ChemistryTopicsListAdapter();

        recyclerView.setAdapter(chemistryTopicsListAdapter);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(getActivity());
        recyclerView.setLayoutManager(layoutManager);

        chemistryTopicsListAdapter.setItemClickListener(onItemClickListener);
