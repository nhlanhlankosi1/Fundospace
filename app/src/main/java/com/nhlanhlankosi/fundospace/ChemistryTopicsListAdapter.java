...
public class ChemistryTopicsListAdapter extends RecyclerView.Adapter {
    ...
    public int getItemCount() {
        return FundoSpaceTopicsData.chemistryTopics.length;
    }
    ...
    private class ListViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bindView(int position) {
            mItemText.setText(FundoSpaceTopicsData.chemistryTopics[position]);
        }
