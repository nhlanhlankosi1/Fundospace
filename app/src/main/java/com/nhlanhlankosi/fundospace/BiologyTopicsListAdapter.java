...
public class BiologyTopicsListAdapter extends RecyclerView.Adapter {
    ...
    public int getItemCount() {
        return FundoSpaceTopicsData.biologyTopics.length;
    }
    ...
    private class ListViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bindView(int position) {
            mItemText.setText(FundoSpaceTopicsData.biologyTopics[position]);
        }
